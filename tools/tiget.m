% TIGET Utility to get previously set function default values 
% USAGE
%   optvalue=tiget(funcname,optname,optvalue);
% INPUTS
...
% been set. Use TISET to change a previously set field.
%
% tiget(funcname) returns the current values of the options structure.

% Copyright (c) 1997-2000, Paul L. Fackler & Mario J. Miranda
% paul_fackler@ncsu.edu, miranda.4@osu.edu

function optvalue = tiget(funcname,optname,optvalue)
