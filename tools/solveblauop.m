% SOLVEBLAUOP Bayesian Learning Anticipated Utility 
%             discrete-state/action controlled Markov process
% USAGE
%   spath = solveblauop(pstar,s,N,x)
% INPUTS
...
function [spath,xpath] = solveblauop(pstar,s,N,x)
